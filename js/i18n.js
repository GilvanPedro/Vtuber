...
const TEXTOS = {
    pt: {
        ...
        'lista.az': 'Nome (A–Z)',
        'lista.maisSeguidores': 'Mais seguidores',
        'lista.menosSeguidores': 'Menos seguidores',
        'lista.filtros': 'Filtros',
        'lista.sorteTitulo': 'Sorteia uma Vtuber entre as que aparecem na lista (respeita a busca e os filtros)',
        ...
        'stats.seguidoresKick': 'seguidores na Kick',
    ...
    en: {
        ...
        'lista.az': 'Name (A–Z)',
        'lista.maisSeguidores': 'Most followers',
        'lista.menosSeguidores': 'Fewest followers',
        'lista.filtros': 'Filters',
        'lista.sorteTitulo': 'Picks a random Vtuber from the ones shown in the list (follows your search and filters)',
        ...
        'stats.seguidoresKick': 'Kick followers',
