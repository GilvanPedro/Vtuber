...
// Vtubers com link de Twitch ou YouTube (para a atualização diária)
export async function vtubersComRedes() {
    return sql(`SELECT id, redes FROM vtubers WHERE redes ? 'twitch' OR redes ? 'youtube' ORDER BY estatisticas_em NULLS FIRST`);
}
